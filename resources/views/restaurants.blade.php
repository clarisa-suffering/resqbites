...
<section class="py-10 px-6">
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <a href="/katalog">
            <div class="bg-white rounded-xl shadow hover:shadow-lg transition-shadow duration-300 p-4 text-center focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
