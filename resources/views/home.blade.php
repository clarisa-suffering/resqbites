...
<div id="default-carousel" class="relative w-full aspect-[3/1]" data-carousel="slide">
    ...
    <div class="relative w-full h-full overflow-hidden">
        <!-- RESQBITE HOME BANNER -->
        <div class="hidden duration-700 ease-in-out h-full" data-carousel-item>
            <img src="Carousel_ResQbite_1.png" class="absolute inset-0 w-full h-full object-cover" alt="...">
        </div>
        <!-- Item 1 -->
        <div class="hidden duration-700 ease-in-out h-full" data-carousel-item>
        ...
        <!-- Item 4 -->
        <div class="hidden duration-700 ease-in-out h-full" data-carousel-item>
            <img src="Carousel_Dimsum_2.png" class="absolute inset-0 w-full h-full object-cover" alt="...">
        </div>
        <!-- Item 5 -->
        <div class="hidden duration-700 ease-in-out h-full" data-carousel-item>
