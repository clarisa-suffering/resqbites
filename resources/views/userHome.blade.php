...
@section('content')
<!-- Carousel Section -->
<section class="relative w-full aspect-[3/1]" data-carousel="slide">
    <!-- Slide 1 (active) -->
    <div class="block duration-700 ease-in-out h-full" data-carousel-item>
        <img src="{{ asset('Carousel_ResQbite_1.png') }}" class="absolute inset-0 w-full h-full object-cover" alt="...">
    </div>
    <!-- Slide 2 -->
    ...
    <!-- Slide 4 -->
    <div class="hidden duration-700 ease-in-out h-full" data-carousel-item>
        <img src="{{ asset('Carousel_Dimsum_2.png') }}" class="absolute inset-0 w-full h-full object-cover" alt="...">
    </div>
    <!-- Slide 5 -->
    <div class="hidden duration-700 ease-in-out h-full" data-carousel-item>
